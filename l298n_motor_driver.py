...
class L298NMotorDriver(UnipolarMotorDriver):
    ...
    UnipolarMotorDriver.Sequence.STEP_SEQUENCE[SEQUENCE] = [
        # Normal L298N input order: IN1, IN2, IN3, IN4.
        # This encodes the motor table columns Pin 1, Pin 3, Pin 2, Pin 4
        # assuming OUT1->Pin 1, OUT2->Pin 2, OUT3->Pin 3, OUT4->Pin 4.
        (1, 0, 0, 0),
        (1, 0, 1, 0),
        (0, 0, 1, 0),
        (0, 1, 1, 0),
